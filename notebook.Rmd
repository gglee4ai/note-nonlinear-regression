...
**Warning:** selfStart 관련한 내용이 잘 안됨 
...
요약 출력(표시되지 않음)은 수동 공급을 사용하여 얻은 것과 동일합니다.
L.minor와 같은 작은 데이터 세트의 경우 기울기 정보를 사용해도 이점이 없습니다. Venables와 Ripley(2002a, pp. 214–216)는 기울기 정보가 함수 평가 횟수를 줄이는 더 큰 데이터 세트와 관련된 예를 살펴봅니다. Fox(2002)는 또 다른 예를 보여줍니다.
